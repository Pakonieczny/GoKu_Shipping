...
const MODEL_RATES = deepFreeze({
  "gpt-6-astra": { inputNanoPerToken: "10000", cacheWriteNanoPerToken: "12500", cachedReadNanoPerToken: "1000", outputNanoPerToken: "50000", longContextThresholdTokens: 272000, longContextInputMultiplierBps: "20000", longContextOutputMultiplierBps: "15000", pricingAsOf: "2026-09-05", promotionalThrough: null, source: "https://developers.openai.com/api/docs/models/gpt-6-astra" },
  "gpt-5.6-sol": {
...
const VALUATION_SCENARIO = OBJ({ id: STR_ENUM(["bear", "base", "bull"]), probabilityPpm: UINT,
  assumptions: ARR(OBJ({ name: TEXT(60), value: INT, unit: TEXT(24) }), 24), realizationPpm: UINT, terminalPriceMicros: UINT });
const VALUATION = OBJ({
  horizonTradingDays: { type: "integer", minimum: 1, maximum: 1260 },
