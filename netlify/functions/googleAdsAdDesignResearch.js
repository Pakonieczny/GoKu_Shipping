...
Plan distinct square, portrait, landscape, banner and skyscraper compositions. Landscape changes to a side-by-side composition; do NOT rotate the product or text 90 degrees. Portrait stacks image and copy vertically. Narrow banners use shortHeadline and a compact native-style CTA, omitting long body copy. Choose image region, alignment and readable colors for desktop and mobile. Each size will get its own editable typography, photo crop and button placement; the clean photos, native CTA and separate copy are what Google Ads receives. Merchant Center receives only photographic product assets.
