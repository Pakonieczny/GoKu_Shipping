...
function buildResponsiveRequest({evidence,request,screenshotDataUrl,sources=[]}){
  const instructions=`You are the Brites Jewelry creative director. Research the exact product and design a NEW purpose-built photographic scene plus a coordinated family of responsive ads. The operator explicitly wants a reimagined product photograph, not merely text over the current photo. Use product references to preserve its exact silhouette, engraving, metal, chain or earrings, count and true physical proportions. The setting, lighting, camera and framing should improve product clarity and fit the audience, without promising measured advertising success.
