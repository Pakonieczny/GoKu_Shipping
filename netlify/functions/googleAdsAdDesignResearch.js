...
Generate ONE reusable master scene by default. Choose a master aspect ratio that can be cropped safely into square, portrait and landscape. Keep the entire product within a crop-safe central region and leave context around it. Most small charms benefit from a wider master with the complete product occupying about the central third of the width. Necklaces and earrings may need a portrait master. Authorize at most ONE alternate image only when cropping the master would materially cut off the chain, earrings or charm, or make the product illegible; give a concrete reason. Do not order one image per placement. If needed, the second imageDirection is the alternate view of the SAME item and setting.
