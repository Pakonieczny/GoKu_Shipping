...
const PACKING_SCHEMA = {"type":"object","additionalProperties":false,"properties":{"profiles":{"type":"array","maxItems":120,"items":{"type":"object","additionalProperties":false,"properties":{"index":{"type":"integer"},"adaptability":{"type":"number"},"interlock":{"type":"number"},"edgeAffinity":{"type":"number"},"priority":{"type":"number"},"edgeRole":{"type":"string","enum":["long-edge","short-edge","corner","interior","either"]},"family":{"type":"string","enum":["round","compact","elongated","concave","branched","angular"]},"mates":{"type":"array","maxItems":6,"items":{"type":"string","enum":["round","compact","elongated","concave","branched","angular"]}},"angles":{"type":"array","maxItems":3,"items":{"type":"number"}},"note":{"type":"string"}},"required":["index","adaptability","interlock","edgeAffinity","priority","edgeRole","family","mates","angles","note"]}},"pairs":{"type":"array","maxItems":240,"items":{"type":"object","additionalProperties":false,"properties":{"a":{"type":"integer"},"b":{"type":"integer"},"score":{"type":"number"},"reason":{"type":"string"}},"required":["a","b","score","reason"]}},"suggestions":{"type":"array","maxItems":24,"items":{"type":"object","additionalProperties":false,"properties":{"index":{"type":"integer"},"angles":{"type":"array","maxItems":3,"items":{"type":"number"}}},"required":["index","angles"]}},"summary":{"type":"string"}},"required":["profiles","pairs","suggestions","summary"]};
