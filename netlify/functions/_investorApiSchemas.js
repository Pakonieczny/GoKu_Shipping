...
const ENUMS = Object.freeze({
  ...
  NavRange: ["1D", "1W", "1M", "3M", "6M", "1Y", "ALL"],
...
const ACTIONS_V2 = Object.freeze({
  ...
  dipSettingsSave: mutation({ enabled: T.bool(), symbols: T.arr(T.ref("Symbol"), 50), watchShortlist: T.bool(), budgetUsd: T.int({ minimum: 1000, maximum: 95000 }), minTradeUsd: T.int({ minimum: 500, maximum: 95000 }), maxTradeUsd: T.int({ minimum: 500, maximum: 95000 }),
    dropBps: T.int({ minimum: 30, maximum: 1500 }), dropWindowMin: T.int({ minimum: 3, maximum: 120 }), zMinTenths: T.int({ minimum: 5, maximum: 80 }), noEntryBeforeMin: T.int({ minimum: 0, maximum: 180 }), speedFactorPct: T.int({ minimum: 0, maximum: 300 }), settleBars: T.int({ minimum: 1, maximum: 15 }), stabilitySigmaTenths: T.int({ minimum: 5, maximum: 100 }),
  ...
  intraday: read({ symbol: T.ref("Symbol"), date: T.ref("Date"), sessions: T.int({ minimum: 1, maximum: 14 }) }, { required: ["symbol"] }),
  history: read({ symbol: T.ref("Symbol"), days: T.int({ minimum: 5, maximum: 400 }) }, { required: ["symbol"] }),
  navSeries: read({ ...acct, range: T.enumOf("NavRange") }),
