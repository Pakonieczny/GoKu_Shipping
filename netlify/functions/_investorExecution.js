...
async function recordFill({ admin = null, accountId, orderSet, leg, fill, bar = null, provenance = null, feeMinor = "0", nowMs = A.now(), source = "paper" } = {}) {
  ...
  const fillDoc = { schemaVersion: "fill.v2", realizedMinor:realizedMinor.toString(), positionQuantityAfter:positionNext.quantityUnits, closedPosition:closed, positionLifecycleId:positionNext.positionLifecycleId || null, fillId, accountId, symbol, orderSetId: orderSet.orderSetId, legId: leg.legId, role: leg.role, side: leg.side, mandateVersionId: orderSet.mandateVersionId,
