...
for(const file of ['charm-nest-backs.js','charm-nest-text.js','charm-nest-export.js','charm-nest-export-ui.js','charm-nest-vector.js','vendor/clipper-6.4.2.js','vendor/clipper-6.4.2-LICENSE.txt'])assert(assets.has(file));
