...
async function functions(st, name, req, res, base) {
  ...
  if (name === 'charmNestLibrary' || name === 'charmNestOutput' || name === 'charmNestAgent-background' || name === 'charmEngrave-background' || name === 'charmMaster-background') {
...
async function start(opts = {}) {
  ...
  for (const n of ['charmNestLibrary', 'charmNestOutput', 'charmNestAgent-background', 'charmEngrave-background', 'charmMaster-background']) { delete require.cache[require.resolve(path.join(fnDir, n + '.js'))]; handlers[n] = require(path.join(fnDir, n + '.js')); }
